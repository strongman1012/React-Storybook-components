...
import { generateUUID } from "src/utills/functions";
import themes from "src/utills/styles/theme";
...
const FileList: FC<FileListProps> = ({
    ...
    const handleOnConfirm = async (filename: string, ext: string) => {
            ...
            >
                ...
                {isEditable &&
                    <Button variant="text"
                        ...
                        color="primary"
                        style={{ position: 'absolute', bottom: 0, width: '100%', padding: '10px', color: '#E34747' }}
                    >Create New
                    </Button>
                }
            </Drawer>
