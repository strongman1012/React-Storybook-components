...
import { setIputJson, setOutputJson } from "src/store/reducers/testReducer";
import { RootState, useDispatch, useSelector } from "src/store";
import { codeFont } from "src/config/app";
...
const DashboardSidebar: FC = () => {
    ...
    const outputJson = useSelector((root: RootState) => root.test.outputJson);
