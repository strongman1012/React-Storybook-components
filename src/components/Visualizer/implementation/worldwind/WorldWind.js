...
/*
 * Overridden functions to change WorldWind behavior.
*/
...
WorldWind.WorldWindow.prototype.computeViewingTransform = function (projection, modelview) {
    ...
    if (projection) {
        ...
        var nearDistance = WorldWind.WWMath.perspectiveNearDistanceForFarDistance(farDistance, 10, this.depthBits);

        farDistance = 5000000000; // Teltrium change to avoid far clipping behind bodies.
