import { ServiceDetails } from "src/services/link-budget/types/networkLibrary";
import { CalculatedLosses, IDataResponse, IDatasetNames, Mapping, ParamGroup } from "../types/LinkBudgetTypes";
